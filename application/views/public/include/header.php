...
<html lang="en">
  <head>
    <title><?php echo $title;?> - MS Group</title>
    <link rel="icon" href="<?php echo base_url();?>assets/public/images/fav.png" type="image/png">
    <meta charset="utf-8">
    	...
    	<div class="container">
    		<div class="row no-gutters d-flex align-items-center align-items-stretch">
    			<div class="col-md-3 d-flex align-items-center py-4">
    				<a class="navbar-brand" href="<?php echo base_url();?>"><img src="<?php echo base_url();?>assets/public/images/mslogo2.png" style="max-height: 70px;"></a>
    			</div>
		    		...
		    		<div class="row d-flex">
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	...
					    	<div class="text d-flex align-items-center">
						    	<span>enquiry.msgroup@gmail.com</span>
						    </div>
					    </div>
					    <div class="col-md d-flex topper align-items-center align-items-stretch py-md-4">
					    	<div class="icon d-flex justify-content-center align-items-center"><span class="icon-phone2"></span></div>
						    <div class="text d-flex align-items-center">
						    	<span>Call Us: +91 663 2548040</span>
						    </div>
					    </div>
